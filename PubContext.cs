...
public class PubContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var authorList = new Author[]{
            ...
            new Author {AuthorId = 6, FirstName = "Amanda", LastName = "Allende" },
            new Author {AuthorId = 7, FirstName = "Astrid", LastName = "Lindgren" },
            new Author {AuthorId = 8, FirstName = "Joakim", LastName = "Anka" }
